...
function Home() {
	return (
		<div className="row text-white content">
			<div className="col-md-6 m-auto mt-5 mb-3 text-center">
				{/* about */}
				<p className="mb-2 mt-5 fs-2 text-warning fw-bold">Hello, I am Dedan Wamalwa.</p>
				...
				{/* skills */}
				<h2 className="mt-5 fw-bold">Skills</h2>
