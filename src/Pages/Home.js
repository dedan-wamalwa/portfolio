    ...
    return (
        <div className="row text-white content">
            <div className="col-md-6 m-auto mt-3 mt-md-5 mb-3 text-center">
                {/* about */}
                <p className="mb-2 mt-5 fs-2 text-warning fw-bold">I am Dedan Wamalwa.</p>
                <p className="fs-4 fw-bold mb-5 mb-md-3">
                    I'm a software engineer with an agile mindset passionate about developing user-centric software products.
                ...
                <p className="text-center mb-5 mt-4 mt-md-0">
                    ...
                    <a
                        href="https://www.linkedin.com/in/dedan-wamalwa-95a6a11a9"
                        target={"_blank"}
                    ...
                    <a
                        href="https://www.instagram.com/dedan_wamalwa/?next=%2F"
                        target={"_blank"}
                        rel="noopener noreferrer"
                        className="mx-2"
                    >
                ...
                {/* skills */}
                <h2 className="mt-5 fw-bold" id="skills">
                    Skills
                </h2>
